...
function LoginForm() {
    ...
    async function handleLogin(e) {
        ...
        setError('');
        try {
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$supabase$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.signInWithPassword({
                email,
                password
            });
            if (error) {
...
_s(LoginForm, "w1RryHeB8XBfpqVvBXsXxUnc/ok=", false, function() {
    return [
