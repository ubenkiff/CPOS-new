...
"[project]/lib/gantt/dates.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/lib/gantt/barGeometry.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$dates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/gantt/dates.ts [app-client] (ecmascript)");
;
function pctInWindow(dateStr, window) {
    if (window.totalDays <= 1) return 0;
    return Math.max(0, Math.min(100, (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$dates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["daysBetween"])(window.start, dateStr) / (window.totalDays - 1) * 100));
}
...
function clipBarToWindow(barStart, barEnd, window) {
    return {
        start: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$dates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["maxDate"])(barStart, window.start),
        end: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$dates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["minDate"])(barEnd, window.end)
    };
}
...
"[project]/lib/gantt/timePages.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function makeWindow(index, start, end, label) {
    return {
        ...
        label,
        totalDays: Math.max(1, (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$dates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["daysBetween"])(start, end) + 1)
    };
}
...
function splitFixedDays(rangeStart, rangeEnd, chunkDays, labelPrefix) {
    ...
    let index = 0;
    while(cur <= rangeEnd){
        const end = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$dates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["minDate"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$dates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addDays"])(cur, chunkDays - 1), rangeEnd);
        pages.push(makeWindow(index, cur, end, `${labelPrefix} ${index + 1}: ${formatRangeLabel(cur, end)}`));
        cur = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$dates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addDays"])(end, 1);
        index += 1;
    }
    return pages;
}
function splitTimelineIntoPages(rangeStart, rangeEnd, mode) {
    ...
    switch(mode){
        ...
        case 'month':
            {
                const pages = [];
                let cur = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$dates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseLocalDate"])(rangeStart);
                const end = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$dates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseLocalDate"])(rangeEnd);
                let index = 0;
                while(cur <= end){
                    const windowStart = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$dates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["maxDate"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$dates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toDateStr"])(cur), rangeStart);
                    const lastDay = new Date(cur.getFullYear(), cur.getMonth() + 1, 0);
                    const windowEnd = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$dates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["minDate"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$dates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toDateStr"])(lastDay), rangeEnd);
        ...
        case 'quarter':
            {
                ...
                while(cur <= end){
                    ...
                    const windowStart = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$dates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["maxDate"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$dates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toDateStr"])(qStart), rangeStart);
                    const windowEnd = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$dates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["minDate"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$dates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toDateStr"])(qEnd), rangeEnd);
        ...
        case 'half-year':
            {
                ...
                while(cur <= end){
                    ...
                    const windowStart = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$dates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["maxDate"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$dates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toDateStr"])(hStart), rangeStart);
                    const windowEnd = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$dates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["minDate"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$dates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toDateStr"])(hEnd), rangeEnd);
        ...
        case 'year':
            {
                ...
                while(cur <= end){
                    ...
                    const windowStart = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$dates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["maxDate"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$dates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toDateStr"])(yStart), rangeStart);
                    const windowEnd = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$dates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["minDate"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$dates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toDateStr"])(yEnd), rangeEnd);
...
"[project]/lib/gantt/headers.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$dates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/gantt/dates.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$timePages$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/gantt/timePages.ts [app-client] (ecmascript)");
;
;
function generateWindowHeaders(window, mode) {
    const segments = [];
    if (mode === 'week' || mode === 'fortnight') {
        const cur = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$dates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseLocalDate"])(window.start);
        const end = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$dates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseLocalDate"])(window.end);
        while(cur <= end){
            const start = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$dates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toDateStr"])(cur);
            const daysInMonth = new Date(cur.getFullYear(), cur.getMonth() + 1, 0).getDate();
            const remaining = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$dates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["daysBetween"])(start, window.end) + 1;
    ...
    if (mode === 'month') {
        segments.push({
            label: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$dates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseLocalDate"])(window.start).toLocaleDateString('en-ZA', {
                month: 'short',
                year: 'numeric'
            }),
    ...
    if (mode === 'quarter') {
        const cur = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$dates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseLocalDate"])(window.start);
        while(cur <= (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$dates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseLocalDate"])(window.end)){
            const start = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$dates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toDateStr"])(cur);
            const nextMonth = new Date(cur.getFullYear(), cur.getMonth() + 1, 1);
            const monthEnd = new Date(nextMonth.getTime() - 86400000);
            const end = monthEnd > (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$dates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseLocalDate"])(window.end) ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$dates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseLocalDate"])(window.end) : monthEnd;
            const days = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$dates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["daysBetween"])(start, (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$dates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toDateStr"])(end)) + 1;
            segments.push({
                label: cur.toLocaleDateString('en-ZA', {
                    month: 'short'
                }),
...
function timelineWidth(window, mode) {
    return window.totalDays * (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$timePages$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getColWidth"])(mode);
}
function dayDatesInWindow(window) {
    return Array.from({
        length: window.totalDays
    }, (_, d)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$dates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addDays"])(window.start, d));
}
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/lib/gantt/rows.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/components/gantt/GanttChartPanel.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$dates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/gantt/dates.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$barGeometry$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/gantt/barGeometry.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$headers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/gantt/headers.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$rows$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/gantt/rows.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$timePages$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/gantt/timePages.ts [app-client] (ecmascript)");
'use client';
;
;
...
function GanttChartPanel({ window, viewMode, rows, theme, toggles, today, rowH = 36, labelW = 280, compact = false, fitWidth = false, collapsedL1, onToggleL1, pageLabel }) {
    ...
    const colW = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$timePages$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getColWidth"])(viewMode);
    const headers = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$headers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateWindowHeaders"])(window, viewMode);
    const chartWidthPx = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$headers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["timelineWidth"])(window, viewMode);
    const dayDates = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$headers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["dayDatesInWindow"])(window);
    function pct(dateStr) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$barGeometry$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["pctInWindow"])(dateStr, window);
    }
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            pageLabel && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                                    ...
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("th", {
                                        ...
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: dayDates.map((date, d)=>{
                                                ...
                                                if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$headers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["shouldShowDayTick"])(viewMode, dayNum)) {
                                                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                            children: rows.map(({ item, level }, i)=>{
                                ...
                                const label = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$rows$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getItemLabel"])(item);
                                ...
                                const baseEnd = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$dates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["resolveEnd"])(item, 'baseline');
                                const planStart = item.planned_start;
                                const planEnd = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$dates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["resolveEnd"])(item, 'planned');
                                const actStart = item.actual_start;
                                const actEnd = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$dates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["resolveEnd"])(item, 'actual') || (item.actual_start && item.percent_complete === 100 ? item.actual_start : undefined);
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                            ...
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    isL1 && onToggleL1 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        style: {
                                                            fontSize: 9,
                                                            color: textMuted,
                                                            width: 10,
                                                    ...
                                                    level === 3 && typeof item.percent_complete === 'number' && !compact && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        style: {
                                                            width: 28,
                                                            textAlign: 'right',
                                                            fontSize: 9,
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                            ...
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    today >= window.start && today <= window.end && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        style: {
                                                            position: 'absolute',
                                                            left: `${pct(today)}%`,
                                                            top: 0,
                                                    ...
                                                    toggles.showBaseline && baseStart && baseEnd && level === 3 && (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$barGeometry$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["barIntersectsWindow"])(baseStart, baseEnd, window) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        style: {
                                                            ...(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$barGeometry$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["barStyleInWindow"])(baseStart, baseEnd, window, '#484f58', 4, rowH / 2 - 2, 0.5)
                                                        }
                                                    }, void 0, false, {
                                                        fileName: "[project]/components/gantt/GanttChartPanel.tsx",
                                                        lineNumber: 303,
                                                    ...
                                                    toggles.showBaseline && baseStart && baseEnd && level !== 3 && (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$barGeometry$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["barIntersectsWindow"])(baseStart, baseEnd, window) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        style: {
                                                            ...(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$barGeometry$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["barStyleInWindow"])(baseStart, baseEnd, window, '#484f58', 8, rowH / 2 - 4, 0.4),
                                                            borderRadius: 0
                                                        }
                                                    }, void 0, false, {
                                                        fileName: "[project]/components/gantt/GanttChartPanel.tsx",
                                                    ...
                                                    toggles.showPlanned && planStart && planEnd && level === 3 && (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$barGeometry$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["barIntersectsWindow"])(planStart, planEnd, window) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        style: {
                                                            position: 'absolute',
                                                            left: `${pct((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$barGeometry$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["clipBarToWindow"])(planStart, planEnd, window).start)}%`,
                                                            width: `${Math.max(0.3, pct((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$barGeometry$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["clipBarToWindow"])(planStart, planEnd, window).end) - pct((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$barGeometry$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["clipBarToWindow"])(planStart, planEnd, window).start))}%`,
                                                            height: 14,
                                                            top: rowH / 2 - 7,
                                                    ...
                                                    toggles.showPlanned && planStart && planEnd && level !== 3 && (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$barGeometry$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["barIntersectsWindow"])(planStart, planEnd, window) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        style: {
                                                            ...(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$barGeometry$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["barStyleInWindow"])(planStart, planEnd, window, barColor + '44', 10, rowH / 2 - 5),
                                                    ...
                                                    toggles.showActual && actStart && level === 3 && (actEnd && (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$barGeometry$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["barIntersectsWindow"])(actStart, actEnd, window) ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        style: {
                                                            ...(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$barGeometry$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["barStyleInWindow"])(actStart, actEnd, window, '#4ade80', 4, rowH - 8, 0.8)
                                                        }
                                                    }, void 0, false, {
                                                        fileName: "[project]/components/gantt/GanttChartPanel.tsx",
                                                        lineNumber: 332,
                                                        columnNumber: 27
                                                    }, this) : actStart >= window.start && actStart <= window.end ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        style: {
                                                            position: 'absolute',
                                                            left: `${pct(actStart)}%`,
                                                            width: 2,
                                                    ...
                                                    level === 3 && baseStart && baseEnd && (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$dates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["daysBetween"])(baseStart, baseEnd) === 0 && baseStart >= window.start && baseStart <= window.end && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        style: {
                                                            position: 'absolute',
...
_c = GanttChartPanel;
var _c;
__turbopack_context__.k.register(_c, "GanttChartPanel");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/components/gantt/GanttPaginatedLayout.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$gantt$2f$GanttChartPanel$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/gantt/GanttChartPanel.tsx [app-client] (ecmascript)");
'use client';
;
;
function GanttPaginatedLayout({ windows, viewMode, rows, theme, toggles, today, variant, pageIndex = 0, rowH, labelW, compact, collapsedL1, onToggleL1 }) {
    if (variant === 'screen') {
        ...
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$gantt$2f$GanttChartPanel$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
            window: window,
            viewMode: viewMode,
            rows: rows,
            theme: theme,
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: windows.map((window, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
...
_c = GanttPaginatedLayout;
var _c;
__turbopack_context__.k.register(_c, "GanttPaginatedLayout");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/lib/gantt/types.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$gantt$2f$GanttPaginatedLayout$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/gantt/GanttPaginatedLayout.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$dates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/gantt/dates.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$rows$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/gantt/rows.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$timePages$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/gantt/timePages.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/gantt/types.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
'use client';
;
...
function GanttModule() {
    ...
    const { isDark } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$theme$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTheme"])();
    ...
    const schedule = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "GanttModule.useMemo[schedule]": ()=>{
            if (!project) return null;
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$dates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["computeScheduleRange"])({
                items: allItems,
    ...
    const timePages = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "GanttModule.useMemo[timePages]": ()=>{
            if (!schedule) return [];
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$timePages$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["splitTimelineIntoPages"])(schedule.rangeStart, schedule.rangeEnd, viewMode);
        }
    }["GanttModule.useMemo[timePages]"], [
        schedule,
        viewMode
    ...
    const rows = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "GanttModule.useMemo[rows]": ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$rows$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildGanttRows"])({
                items: allItems,
                collapsedL1,
                showCriticalOnly
            })
    }["GanttModule.useMemo[rows]"], [
        allItems,
        collapsedL1,
        showCriticalOnly
    ]);
    const l3Items = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "GanttModule.useMemo[l3Items]": ()=>allItems.filter({
                "GanttModule.useMemo[l3Items]": (r)=>Number(r.hierarchy_level) === 3
            }["GanttModule.useMemo[l3Items]"])
    }["GanttModule.useMemo[l3Items]"], [
        allItems
    ]);
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GANTT_VIEW_MODES"].map(({ value, label })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("strong", {
                                                ...
                                                children: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GANTT_VIEW_MODES"].find((m)=>m.value === viewMode)?.label
                                            }, void 0, false, {
                                                fileName: "[project]/app/dashboard/[projectid]/gantt/page.tsx",
                                                lineNumber: 328,
                                                columnNumber: 35
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$gantt$2f$GanttPaginatedLayout$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                variant: "screen",
                                windows: timePages,
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            project.project_code,
                                            " · Gantt · ",
                                            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$gantt$2f$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GANTT_VIEW_MODES"].find((m)=>m.value === viewMode)?.label,
                                            " · ",
                                            rangeStart,
                                            " → ",
                                            rangeEnd
...
_s(GanttModule, "5Rq0rDqQHVn6vxDdpGaMBXBcJho=", false, function() {
    return [
...
//# sourceMappingURL=_98259e93._.js.map