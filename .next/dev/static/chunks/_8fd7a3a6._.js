...
function RegisterPage() {
    ...
    async function handleRegister(e) {
        ...
        setLoading(true);
        setError('');
        const { data, error: signUpError } = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$supabase$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.signUp({
            email,
            password,
            options: {
                data: {
...
_s(RegisterPage, "b2XUsj0P0mtai3sExFskZPE7wRI=", false, function() {
    return [
