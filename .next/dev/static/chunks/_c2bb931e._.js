...
function Dashboard() {
    ...
    async function fetchProjects(userId) {
        const { data: profile } = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$supabase$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('users').select('role').eq('userid', userId).maybeSingle();
        const role = String(profile?.role || '').toLowerCase();
        const adminByRole = role === 'admin' || role === 'administrator';
        setIsAdmin(adminByRole);
        if (adminByRole) {
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$supabase$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('projects').select('*').order('created_at', {
                ascending: false
            });
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$supabase$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].rpc('list_project_teasers');
        if (!error) setProjects(data || []);
        setLoading(false);
    }
...
_s(Dashboard, "CEEr8RpiSgcGccEo0Gb3py04+e4=", false, function() {
    return [
...
//# sourceMappingURL=_c2bb931e._.js.map