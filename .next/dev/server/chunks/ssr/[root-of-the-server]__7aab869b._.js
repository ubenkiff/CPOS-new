...
"[project]/app/projects/new/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function NewProject() {
    ...
    const [codeManual, setCodeManual] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    async function handleSubmit(e) {
        ...
        const { error: profileUpsertError } = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$supabase$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('users').upsert([
            {
                userid: user.id,
                email: user.email
            }
        ...
        if (!isAdmin && !isEnterprise) {
            const { count, error: countErr } = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$supabase$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('projects').select('*', {
                count: 'exact',
                head: true
            }).eq('user_id', user.id);
            if (countErr) {
        ...
        const { error: insertError } = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$supabase$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('projects').insert([
            {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$supabase$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('dashboard_metrics').insert([
            {
                projectid: form.projectid
            }
        ]);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7aab869b._.js.map